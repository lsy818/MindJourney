...
旧r10片0–5曾因额外thinking检查失败；r11非致命告警修复保留来源续接7道答案。片0/1/2因共享盘满失败的56/64/50题检查点已保存；12:51恢复可写后续交72732_[0–2%3]。片4仍运行40/100；片3=71779_3及71510片5–7已释放暂缓恢复排队，片8–9尚未提交。旧未启动71345_[4–5]经PENDING确认后合并替换，记录全部保留；同组跨数组并发合计≤5。旧1024不合并。见[续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json)。

### Qwen2.5-VL-72B-Instruct（P1）

8192版本分片0 `70202_0` 已核验：**36 / 100（36.00%）**，0skip，耗时5:52:39。这是100题分片结果，尚无1000题全量成绩；不将该比例填入全量总览。结果、COMPLETE及552文件完整原始日志均保留，见[核验与归档索引](./records/P1_MMSI72B_SHARD0_20260916.json)。片1已提交为 `72432_1`，12:45已释放暂缓并恢复排队，继续3×H20（TP2+独占SVC1）及显式0.93，其他设置不变；片2–9待提交槽。
