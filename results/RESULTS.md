...
09-14 14:55最新状态：正确P1完成1/4组。MindCube/9B完成0–8共9/11片，部分360/855（42.11%），仅余9–10运行。MMSI/27B片0–3为71064_0、71095_1、71114_2、71151_3；未启动片4已与新片5合并提交71345（4-5%1），同组跨数组上限仍5。72B70202_0等3×H20。2运行/4×A100、10/10提交槽；节点11排空，其他任务继续等待调度。新增片8完整结果与日志已核验归档，见[记录](./records/P1_9B_SHARD8_20260914.json)。

## 全部实验总览

| 数据集 | 模型 | 优先级 | 状态 | 正确 / 总数 | 准确率 | 结果文件 |
|---|---|---|---|---:|---:|---|
| MMSI-Bench 1000 | Qwen3.5-27B | P1 | r11片0–5排队：71064/71095/71114/71151及71345[4–5] | — | — | [续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json) |
...
| MindCube 1050 | Qwen3.5-9B | P1 | 完成0–8；9–10运行71002/71041 | — | — | [续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json) |
...
当前版本：**8192最大输出、no-thinking**。三组Qwen3使用非致命告警修复r11，已保存r10题按明确来源续接；72B保留r10。旧1024全部保留、不混合统计。MindCube/3.8全量11片已完成，9B已有9片严格核验完成；正确P1完成1/4组；详见[续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json)及[实验日志](./EXPERIMENTS.md)。
...
旧r10片0–5曾因额外thinking检查失败；用户已授权非致命告警修复。r11已保留来源续接7道保存答案，片0=71064_0、片1=71095_1、片2=71114_2、片3=71151_3及片4–5=71345已提交排队；旧未启动71187_4已合并替换，日志保留，其余待提交槽。旧1024不合并。见[续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json)。
...
旧r10数组70200的0–5曾因额外thinking检查失败；r11已保留来源续接44道保存答案；当前0–8完成、9–10运行，所有分片均已完成或已提交。旧现场与1024全部保留，1024不合并。见[续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json)。
