...
09-17 21:41最新状态：正确P1仍2/4组全量完成。MMSI/27B片4已核验归档28/100（3题r10+97题r11），片0/1/2/3运行（8×A100），5–7排队；MMSI/72B片0已归档36/100，片1/2排队。新片2作业73646_2保持3H20/TP2+SVC1/显式0.93。账户4/5运行、10/10提交，存储9.8T可用；见[分片4核验与调度记录](./records/P1_MMSI27B_SHARD4_20260917.json)。

## 全部实验总览

| 数据集 | 模型 | 优先级 | 状态 | 正确 / 总数 | 准确率 | 结果文件 |
|---|---|---|---|---:|---:|---|
| MMSI-Bench 1000 | Qwen3.5-27B | P1 | 片4归档；0/1/2/3运行，5–7排队 | — | — | [续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json) |
...
21:41片0/1/2/3运行，5–7排队，8–9尚未提交。片1本次续跑73395_1已实际推理；原ENOSPC故障根因仍未确认。跨数组总并发上限5，保留全部旧结果，1024结果不混入统计。
