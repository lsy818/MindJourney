...
09-18 17:13最新状态：正确P1仍2/4组全量完成。MMSI/27B片0/2/4已归档，1/3/5运行、6/7/8/9排队；72B片0/1已归档36/100、31/100，片2启动加载、片3已补交。账户4/5运行、10/10提交，共6×A100＋3×H20；空余运行名额等待集群资源。见[72B片1核验与补交记录](./records/P1_MMSI72B_SHARD1_20260918.json)。
...
| MMSI-Bench 1000 | Qwen2.5-VL-72B-Instruct | P1 | 片0/1归档；片2启动加载，片3排队 | — | — | [提交记录](./mmsi/qwen2.5-vl-72b/svc/mj-p1-8192-mmsi-qwen25vl-72b-h20-r10-20260912/submission_initial.txt) |
...
09-18 17:13片2=`73646_2`已在节点16启动加载模型，尚无保存答案；片3=`73871_3`已排队，各3×H20（TP2+独占SVC1），实际export显式0.93，跨数组总并发仍2；片4–9待槽。见[片3实际提交记录](./submissions/P1_SUBMIT_73871.txt)。
