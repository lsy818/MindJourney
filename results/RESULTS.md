...
09-13 14:53最新状态：MindCube/3.8片0–6已核验完成，部分成绩382/665（57.44%，非全量）。片7/8/9运行，10排队70775_10。MindCube/9B片0/1运行、2排队70766，新增片3排队70825；72B片0继续排队。5/5运行、10×A100，补交后10/10提交槽已满。原始结果与续接来源已保存，8192/BF16/65536/no-thinking及评分不变。详见[最新完成片核验](./P1_COMPLETED_SHARD6_20260913.json)、[续跑清单](./P1_AUDITFIX_EXECUTION_20260912.json)及[实验日志](./EXPERIMENTS.md)。
...
| MindCube 1050 | Qwen3.5-9B | P1 | r11片0/1运行、2/3排队70766/70825；保留44题检查点 | — | — | [续跑清单](./P1_AUDITFIX_EXECUTION_20260912.json) |
| MindCube 1050 | Qwen3.8-27B | P1 | 已完成0–6；7/8/9运行，10排队70775 | — | — | [完成片核验](./P1_COMPLETED_SHARD6_20260913.json) |
...
当前版本：**8192最大输出、no-thinking**。三组Qwen3使用非致命告警修复r11，已保存r10题按明确来源续接；72B保留r10。旧1024全部保留、不混合统计。MindCube/3.8已有7片严格核验完成，尚无正确P1全量成绩；详见[续跑清单](./P1_AUDITFIX_EXECUTION_20260912.json)及[实验日志](./EXPERIMENTS.md)。
