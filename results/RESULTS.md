...
09-18 08:46最新状态：正确P1仍2/4组全量完成。MMSI/27B片0与4已核验归档，分别32/100、28/100；片1/2/3/5运行（8×A100），6/7/8排队（新片8作业73768_8）。MMSI/72B片0归档36/100，片1/2排队，3×H20/TP2+SVC1/显式0.93不变。账户4/5运行、10/10提交；见[分片0核验与调度记录](./records/P1_MMSI27B_SHARD0_20260918.json)。

## 全部实验总览

| 数据集 | 模型 | 优先级 | 状态 | 正确 / 总数 | 准确率 | 结果文件 |
|---|---|---|---|---:|---:|---|
| MMSI-Bench 1000 | Qwen3.5-27B | P1 | 片0/4归档；1/2/3/5运行，6/7/8排队 | — | — | [续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json) |
| MMSI-Bench 1000 | Qwen2.5-VL-72B-Instruct | P1 | 片0归档；1/2排队72432/73646 | — | — | [提交记录](./mmsi/qwen2.5-vl-72b/svc/mj-p1-8192-mmsi-qwen25vl-72b-h20-r10-20260912/submission_initial.txt) |
...
09-18 08:46片1/2/3/5运行，已保存81/88/72/1题（片5的1题为r10继承，已观察到新推理但尚无新保存题）；6/7/8排队，片9待槽。新片8=`73768_8`，先将原72732数组限流降到1后补交，跨所有27B活动数组总上限仍5。历史ENOSPC根因未确认，保留全部旧结果，1024结果不混入统计。

### Qwen2.5-VL-72B-Instruct（P1）

8192版本分片0 `70202_0` 已核验：**36 / 100（36.00%）**，0skip，耗时5:52:39。这是100题分片结果，尚无1000题全量成绩；结果、COMPLETE及552文件完整原始日志均保留，见[核验与归档索引](./records/P1_MMSI72B_SHARD0_20260916.json)。片1=`72432_1`、新片2=`73646_2`排队，各3×H20（TP2+独占SVC1），实际export显式0.93，跨数组总并发2；片3–9待槽。见[片2实际提交记录](./submissions/P1_SUBMIT_73646.txt)。
