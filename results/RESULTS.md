...
09-18 15:13最新状态：正确P1仍2/4组全量完成。MMSI/27B片0/2/4已归档32/100、38/100、28/100；1/3/5运行，6/7/8/9排队，全部分片已提交。72B片0归档36/100，片1实际推理至63/100，片2排队。账户4/5运行、10/10提交，共6×A100＋3×H20；空余运行名额等待集群资源。见[片2核验与补交记录](./records/P1_MMSI27B_SHARD2_20260918.json)。

## 全部实验总览

| 数据集 | 模型 | 优先级 | 状态 | 正确 / 总数 | 准确率 | 结果文件 |
|---|---|---|---|---:|---:|---|
| MMSI-Bench 1000 | Qwen3.5-27B | P1 | 片0/2/4归档；1/3/5运行，6/7/8/9排队 | — | — | [续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json) |
| MMSI-Bench 1000 | Qwen2.5-VL-72B-Instruct | P1 | 片0归档；片1实际推理，片2排队 | — | — | [提交记录](./mmsi/qwen2.5-vl-72b/svc/mj-p1-8192-mmsi-qwen25vl-72b-h20-r10-20260912/submission_initial.txt) |
...
8192版本分片0 `70202_0` 已核验：**36 / 100（36.00%）**，0skip，耗时5:52:39。这是100题分片结果，尚无1000题全量成绩；结果、COMPLETE及552文件完整原始日志均保留，见[核验与归档索引](./records/P1_MMSI72B_SHARD0_20260916.json)。09-18 15:13片1=`72432_1`已在节点16实际推理，保存63/100题；片2=`73646_2`排队，各3×H20（TP2+独占SVC1），实际export显式0.93，跨数组总并发2；片3–9待槽。见[片2实际提交记录](./submissions/P1_SUBMIT_73646.txt)。
