...
09-19 04:50最新状态：正确P1仍2/4组全量完成。MMSI/27B片0–4已核验，片3新结果30/100；5/8运行，6/7/9排队。72B片0/1/2已核验，3/4/5/6排队（新增6，5–6合并73994）。账户2/5运行、10/10提交，4×A100。27B片1/3和72B片2完整日志在服务器/本地保留，上传待授权。见[片3核验与补交记录](./records/P1_MMSI27B_SHARD3_20260919.json)。

## 全部实验总览

| 数据集 | 模型 | 优先级 | 状态 | 正确 / 总数 | 准确率 | 结果文件 |
|---|---|---|---|---:|---:|---|
| MMSI-Bench 1000 | Qwen3.5-27B | P1 | 片0–4核验；5/8运行，6/7/9排队 | — | — | [续跑清单](./records/P1_AUDITFIX_EXECUTION_20260912.json) |
| MMSI-Bench 1000 | Qwen2.5-VL-72B-Instruct | P1 | 片0/1/2核验；片3/4/5/6排队 | — | — | [提交记录](./mmsi/qwen2.5-vl-72b/svc/mj-p1-8192-mmsi-qwen25vl-72b-h20-r10-20260912/submission_initial.txt) |
