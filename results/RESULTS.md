...
09-18 20:01最新状态：正确P1仍2/4组全量完成。MMSI/27B片0/1/2/4已归档，3/5运行、6/7/8/9排队；72B片0/1已归档，片2实际推理64/100，片3–4合并为73879排队。账户3/5运行、10/10提交，共4×A100＋3×H20；当前兼容节点各最多空1卡，等待足够资源。见[27B片1核验与补交记录](./records/P1_MMSI27B_SHARD1_20260918.json)。
...
| MMSI-Bench 1000 | Qwen2.5-VL-72B-Instruct | P1 | 片0/1归档；片2推理，片3/4排队 | — | — | [提交记录](./mmsi/qwen2.5-vl-72b/svc/mj-p1-8192-mmsi-qwen25vl-72b-h20-r10-20260912/submission_initial.txt) |
...
09-18 20:01片2=`73646_2`实际推理，已保存64/100；仅排队的旧片3=`73871_3`与新片4合并为`73879_[3-4%1]`，片3排队年龄重置但没有中断运行作业。每片3×H20（TP2+独占SVC1），实际export显式0.93，跨数组总并发仍2；片5–9待槽。旧73871记录保留，见[新数组实际提交记录](./submissions/P1_SUBMIT_73879.txt)。
